/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 94ea38a51bd0659fd517ca173f02f024)
...
declare namespace Cloudflare {
	...
	interface Env {
		PAYMENT_PROCESSING_QUEUE: Queue;
		DONATION_PROCESSING_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CASHFREE_CLIENT_ID" | "CASHFREE_CLIENT_SECRET" | "DATABASE_URL">> {}
}
